...
$pdf->MultiCell(19.5, 1, 'Laporan Data Supplier', 0, 'C');
$pdf->SetX(2.8);
...
$pdf->Cell(5, 1, 'NAMA SUPPLIER', 1, 0, 'C');
$pdf->Cell(10.5, 1, 'ALAMAT', 1, 0, 'C');
$pdf->Cell(2.8, 1, 'NO TELEPON', 1, 1, 'C');
...
while ($row = mysqli_fetch_array($query)) {
    $pdf->SetFont('Times', '', 8);
    $pdf->Cell(0.8, 1, $no++, 1, 0, 'C');
    $pdf->Cell(5, 1, $row['nama_supplier'], 1, 0, 'C');
    $pdf->Cell(10.5, 1, $row['alamat'], 1, 0, 'C');
    $pdf->Cell(2.8, 1, $row['no_telp'], 1, 1, 'C');
}
