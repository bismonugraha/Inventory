...
$pdf->MultiCell(19.5, 1, 'Laporan Barang Masuk', 0, 'C');
$pdf->SetX(2.8);
...
$pdf->Cell(3, 1, 'KODE BARANG', 1, 0, 'C');
$pdf->Cell(6, 1, 'NAMA BARANG', 1, 0, 'C');
$pdf->Cell(2.8, 1, 'JENIS BARANG', 1, 0, 'C');
$pdf->Cell(3.5, 1, 'SUPPLIER', 1, 0, 'C');
$pdf->Cell(3, 1, 'JUMLAH MASUK', 1, 1, 'C');
...
while ($row = mysqli_fetch_array($query)) {
    $pdf->SetFont('Times', '', 8);
    $pdf->Cell(0.8, 1, $no++, 1, 0, 'C');
    $pdf->Cell(3, 1, $row['kode_barang'], 1, 0, 'C');
    $pdf->Cell(6, 1, $row['nama_barang'], 1, 0, 'C');
    $pdf->Cell(2.8, 1, $row['jenis_barang'], 1, 0, 'C');
    $pdf->Cell(3.5, 1, $row['nama_supplier'], 1, 0, 'C');
    $pdf->Cell(3, 1, $row['jumlah_masuk'], 1, 1, 'C');
}
